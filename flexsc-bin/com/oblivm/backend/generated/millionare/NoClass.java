package com.oblivm.backend.generated.millionare;
...
public class NoClass<t__T> implements IWritable<NoClass<t__T>, t__T>, ISecureRunnable<t__T> {
	...
	public t__T[] main(t__T[] x, t__T[] y) throws Exception {
		...
		t__T f_tmp_0 = intLib.not(intLib.geq(x, y));
		t__T __tmp0 = f_tmp_0;
		int __tmp1 = 0;
		t__T[] f_tmp_3 = env.inputOfAlice(Utils.fromInt(__tmp1, 32));
		t__T[] __tmp2 = intLib.mux(ret, f_tmp_3,__tmp0);
		ret = __tmp2;
		t__T f_tmp_4 = intLib.not(__tmp0);
		t__T __tmp3 = f_tmp_4;
		int __tmp4 = 1;
		t__T[] f_tmp_7 = env.inputOfAlice(Utils.fromInt(__tmp4, 32));
		t__T[] __tmp5 = intLib.mux(ret, f_tmp_7,__tmp3);
		ret = __tmp5;
		return ret;
